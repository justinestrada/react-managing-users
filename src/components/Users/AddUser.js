...
const AddUser = props => {
  ...
  return (
    <div>
      {error && (
        <ErrorModal title="An error occured!" message="Something went wrong!" onSetError={errorHandler}/>
      )}
      <Card className={classes.input}>
        <form onSubmit={addUserHandler}>
          ...
          <input id="age" type="number" name="age" value={enteredAge} onChange={ageChangeHandler}/>
